      ...
      var l = (function (t, e, n) {
        ...
        C = function (t) {
          ...
          for (e = 0; e < T.length; e++)
            if ((n = T[e] + i) in R.style) return { dom: n, css: L[e] + t };
        },
        I = (e.support = {
            ...
            if (t) {
              ...
              if ("object" == o) {
                ...
                h.call(
                  ...
                  f.call(this),
                  c > 0 &&
                    ((this.timer = new j({ duration: c, context: this })),
                    (this.active = !0),
    ...
    i.define(
      ...
      (t.exports = function (t, e) {
        var n,
          ...
          O = t(document);
        function R() {
          (n = d && i.env("design")), (u = O.find(v)).each(T);
        }
        function T(e, r) {
          var u = t(r),
            l = t.data(r, v);
          l ||
              ...
              return c(function (n) {
                if (e.open) {
                  ...
                  if (!r.closest(".w-dropdown-toggle").length) {
                    var o = -1 === t.inArray(e.el[0], r.parents(v)),
                      a = i.env("editor");
                    if (o) {
                      if (a) {
                        var s =
            ...
            (l.mouseMoveOutside = (function (e) {
              return c(function (n) {
                if (e.open) {
                  var i = t(n.target),
                    r = -1 === t.inArray(e.el[0], i.parents(v));
                  if (r) {
                    var o = i.parents(
                        ".w-editor-bem-EditorHoverControls"
                      ).length,
        ...
        function F(t, e) {
          if (!t.open) {
            ...
            if (
              ...
              var h = u + o;
              l(t.menu).add(d).set({ y: -h }).start({ y: 0 }).then(v);
            }
          }
          function v() {
      ...
      (t.exports = function (t, e) {
        ...
        function k(e, n) {
          ...
          r.el.off(h),
            ...
            E(r),
            s
              ? (r.el.on("setting" + h, I(r)), C(r), (r.hasTimer = !1))
              : (r.el.on("swipe" + h, I(r)),
                r.left.on("click" + h, R(r)),
                r.right.on("click" + h, T(r)),
                r.left.on("keydown" + h, O(r, R)),
        ...
        function D(e, n) {
          ...
          if (
            ...
            s || (v.each(g.intro), m.each(g.outro)),
            n.immediate && !w)
          )
            return l(v).set(h), void R();
          if (e.index !== e.previous) {
            if (
              ...
              return (
                (E = "opacity " + A + "ms " + y),
                l(p).set({ visibility: "" }).add(E).start({ opacity: 0 }),
                void l(v)
...
function tz() {
  window.location.href = "https://twitter.com/0xSoularis";
}
function tz2() {
  window.location.href = "https://discord.com/invite/Zmwhn5pV";
}
